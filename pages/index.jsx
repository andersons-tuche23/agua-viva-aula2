                  ...
                  <div className="form">
                    ...
                    >
                      ...
                      {qtdDomingoManha < qtdMAxima && (
                        <option value="manha">{horario ? "terça - feira"  : "sabado"} - 15hs</option>
                      )}
                      {qtdDomingoNoite < qtdMAxima && (
                        <option value="noite">{horario ?  "terça - feira"  : "sabado"} - 17:30hs </option>
                      )}
                    </select>
                    {/* <br></br>
                    ...
                    <div className="vagas">
                      ...
                      <span>
                       {existe1 ? <>terça - feira 18hs  -</>: <>sabado 15hs - </>}
                        {qtdDomingoManha >= qtdMAxima && (
                          <small className="red"> vagas encerradas</small>
                        )}
                        {qtdDomingoManha < qtdMAxima && (
                      ...
                      <span>
                      {horario ?  "terça - feira"  : "sabado"}  17:30hs -
                        {qtdDomingoNoite >= qtdMAxima && (
                          <small className="red"> vagas encerradas</small>
                        )}
                        {qtdDomingoNoite < qtdMAxima && (
